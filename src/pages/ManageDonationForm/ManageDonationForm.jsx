...
import { Button, Heading, Flex, Center, useToast } from '@chakra-ui/react';
  ...
  return (
    <>
      ...
      <Flex minWidth="max-content" alignItems="center" minHeight="50%" s>
        <EditItemsList items={items} setItems={setItems} setNewEntries={setNewEntries} isAccepted />
        <EditItemsList items={items} setItems={setItems} setNewEntries={setNewEntries} />
      </Flex>
